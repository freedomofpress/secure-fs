...
def test_safe_mkdir_with_unsafe_path():
    """
...
def test_safe_mkdir_fixes_insecure_permissions_on_base_dir():
    """
...
def test_safe_mkdir_leaves_parent_dir_permissions_alone_on_base_path():
    """
...
def test_safe_mkdir_fixes_insecure_permissions_on_rel_dir():
    """
...
def test_safe_mkdir_fixes_insecure_permissions_on_parent_dir():
    """
    Test that safe_mkdir raises when a parent directory has insecure permissions.
    """
    with tempfile.TemporaryDirectory() as temp_dir:
...
def test_safe_mkdir_fixes_insecure_permissions_on_inner_parent_dir():
    """
    Test that safe_mkdir raises when a parent directory has insecure permissions.
    """
    with tempfile.TemporaryDirectory() as temp_dir:
...
def test_safe_mkdir_fixes_insecure_permissions_on_last_parent_dir():
    """
    Test that safe_mkdir raises when a parent directory has insecure permissions.
    """
    with tempfile.TemporaryDirectory() as temp_dir:
